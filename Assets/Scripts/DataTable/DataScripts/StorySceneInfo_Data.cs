...
public class StorySceneInfo_Data : ScriptableObject
{
    ...
    public void UpdateStorySceneInfoData()
    {
        ...
        dataList = GameManager.instance.GetComponent<ScriptableObjectManager>().GetScriptableObjectToObjectList<StorySceneInfo_Object>(spreadSheetAddress, spreadSheetRange, spreadSheetWorksheet);
